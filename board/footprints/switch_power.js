    ...
    body: p => {
      ...
      const back_switch = `
        ...
        const shared_2 = `
          ...
          (pad "" np_thru_hole circle (at 0.025 1.5 ${90 + p.rot}) (size 0.9 0.9) (drill 0.9) (layers *.Cu *.Mask))
          (model "board/sessile.3dshapes/PCM12SMTR.step" (offset (xyz 0.000 0.000 0.250)) (scale (xyz 1 1 1)) (rotate (xyz 90 180 90)))
          (property "LCSC" "C221841" (at 0 0 0) (effects (font (size 1.27 1.27) ) (hide yes)))
        `
